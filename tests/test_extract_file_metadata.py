"""Each uploaded file is fingerprinted and its metadata recorded for deduplication and audit."""

from datetime import datetime

import pytest

from src.pipeline.extract_file_metadata import get_sha3_256, get_metadata


class TestUploadedFileIngestion:
    def test_uploaded_file_is_fingerprinted_for_deduplication(self, tmp_path):
        """Each file receives a SHA3-256 fingerprint so re-uploads of the same file can be detected."""
